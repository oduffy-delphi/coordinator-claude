...
- **ue-gameplay-engineer** (Sonnet) — actors, combat, AI, GAS, inventory, Niagara VFX authoring (full graph), input, checkpoints, quests, demo replay
...
**ue-docs-researcher** — multi-source RAG synthesis (421,935 vectors). Route: multi-step UE lookups. Single lookups: quick_ue_lookup directly.
