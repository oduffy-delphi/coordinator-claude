...
See the parent [ARCHITECTURE.md](../../docs/architecture.md) for the full conceptual model.
...
See [ARCHITECTURE.md](../../docs/architecture.md) § "The Write-Ahead Status Protocol" for the conceptual model and state machine.
