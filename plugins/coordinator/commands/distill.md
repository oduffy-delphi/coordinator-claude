...
**Reference:** Full pipeline design in `~/.claude/plugins/coordinator/pipelines/artifact-distillation/PIPELINE.md`. Agent prompt templates in the same directory's `agent-prompts.md`.
