...
- **Staff Synthesizer** (1, Opus) — blocked until all debaters complete, then reads all positions and writes the final output
...
| `zoli` | `coordinator/agents/zoli-ambition-advocate.md` |
| `sid` | `game-dev/agents/sid-game-dev.md` |
| `fru` | `web-dev/agents/fru-ux-reviewer.md` |
| `pali` | `web-dev/agents/pali-frontend-reviewer.md` |
...
Agent(
  ...
  name: "synthesizer",
  model: "opus",
  subagent_type: "coordinator:staff-synthesizer",
...
| Slug | subagent_type |
|---|---|
| `patrik` | `coordinator:patrik-code-review` |
| `zoli` | `coordinator:zoli-ambition-advocate` |
| `sid` | `game-dev:sid-game-dev` |
| `fru` | `web-dev:fru-ux-reviewer` |
| `pali` | `web-dev:pali-frontend-reviewer` |
| `camelia` | `data-science:camelia-data-scientist` |
