...
Invoke the `coordinator:update-docs` skill for full repo-wide maintenance. This commits and pushes to the current branch.
...
**RAM cache:** [refreshed by /update-docs / not present]
