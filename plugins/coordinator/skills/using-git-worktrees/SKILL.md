...
<!-- Review: Patrik — removed stale attribution artifact -->
...
```
You: I'm using the coordinator:using-git-worktrees skill to set up an isolated workspace.
...
**Called by:**
<!-- Review: Patrik — removed ghost callers; brainstorming doesn't invoke this skill; subagent-driven-development no longer exists -->
- **/execute-plan** — Use when branch-level isolation is needed (not required for single-branch sequential execution)
