...
- **Backstop:** Zolí
- **Agent file:** `agents/patrik-code-review.md`

### Zolí (zoli-ambition-advocate)
- **Signals:** N/A — backstop only, never primary
- **Model:** opus
- **Effort:** Medium
- **Backstop:** None (terminal backstop)
- **Agent file:** `agents/zoli-ambition-advocate.md`
...
Per-project config in `.claude/coordinator.local.md`:
    ...
    ---
    project_type: game      # game | web | data-science | pure-docs
...
- **Purely mechanical changes** (rename, format, move): `/validate` is sufficient, skip review
